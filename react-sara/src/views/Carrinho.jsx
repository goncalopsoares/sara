                    ...
                    <div>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', borderRadius: '1rem', border: '1px solid grey', padding: '0.4rem', fontSize:"0.8rem", marginBottom: "0.3rem" }}>
                                                {member && (
                                                    <img
                                                        ...
                                                        src={`http://deca-sara.ua.pt:8080${getUserInfo(member.utilizador_id_utilizador).avatar_utilizador}`}
                        ...
                        (
                            ...
                            <div>
                                ...
                                <img src={`http://deca-sara.ua.pt:8080${Uc.icone}`} alt={Uc.nome} className="h-16 w-16 p-0" style={{ marginRight: '0.5rem', borderRadius: '1rem 0 0 1rem' }} />
                        ...
                        {professor && (
                            ...
                            <div>
                                ...
                                <p style={{ display: 'flex', alignItems: 'center', borderRadius: '1rem', border: '1px solid grey', padding: '0.4rem', fontSize:"0.8rem" }}>
                                        <img
                                            className="rounded-full h-7 w-7 mr-2"
                                            src={`http://deca-sara.ua.pt:8080${getUserInfo(professor.utilizador_id_utilizador).avatar_utilizador}`}
               ...
               Equipamentos Selecionados:
                    {cart.map((item, index) => (
                        ...
                        <li key={index}>
                            ...
                            src={`http://deca-sara.ua.pt:8080${item.imagem_modelo_equipamento}`}
                            />
                             <div style={{ display: 'flex', flexDirection: 'column' }}>
