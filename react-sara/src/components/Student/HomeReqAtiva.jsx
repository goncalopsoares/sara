...
const HomeReqAtiva = ({ req }) => {
    ...
    let textColor;
    switch (ultimoEstado.nome_estado) {
        case "Aguarda confirmação do SARA":
        case "Aguarda confirmação do professor":
            cardBackgroundColor = "#F0F0F0";
            textColor = "#818181";
            break;
        case "Por recolher":
            cardBackgroundColor = "#F3FAE6";
            textColor = "#1C7A00";
            break;
        case "Por devolver":
            cardBackgroundColor = "#EFE5FB";
            textColor = "#4300D4";
            break;
        default:
            cardBackgroundColor = "#B30020";
            textColor = "#B30020";
    }
    ...
    return (
        <div
            ...
            className={`${cardBackgroundColor} p-4 mb-2`}
            style={{
                borderRadius: "1rem",
        ...
        >
            ...
            <div
                className="text-uppercase font-bold txt-green-900 mb-4"
